...
public class readString extends TranslatorBlock {
	private static ResourceBundle uiMessageBundle = ResourceBundle.getBundle("com/ardublock/block/ardublock");
	public readString (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
	...
	@Override
		...
		{	
			...
			if(portNumber.equals("0"))
				portNumber = "";
			return codePrefix + "Serial" + portNumber + ".readString()" + codeSuffix;	
		}
}

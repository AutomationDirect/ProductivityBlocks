...
public class printBin extends TranslatorBlock {
	private static ResourceBundle uiMessageBundle = ResourceBundle.getBundle("com/ardublock/block/ardublock");
	public printBin (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
	...
	@Override
		public String toCode() throws SocketNullException, SubroutineNotDeclaredException
		{
			...
			if(portNumber.equals("0"))
				portNumber = "";
			if(newlinebool == "true") {
				return "Serial" + portNumber + ".println("+ value +", BIN);";
			}else
				return "Serial" + portNumber + ".print(" + value + ", BIN);" ;	
		}
}

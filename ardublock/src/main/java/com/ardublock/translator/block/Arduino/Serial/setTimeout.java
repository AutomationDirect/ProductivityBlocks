...
public class setTimeout extends TranslatorBlock {
	private static ResourceBundle uiMessageBundle = ResourceBundle.getBundle("com/ardublock/block/ardublock");
	public setTimeout (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
	...
	@Override
		...
		{	
			String timeout = this.getRequiredTranslatorBlockAtSocket(0).toCode();
			...
			if(portNumber.equals("0"))
				portNumber = "";
			return "Serial" + portNumber + ".setTimeout("+timeout+");";	
		}
}

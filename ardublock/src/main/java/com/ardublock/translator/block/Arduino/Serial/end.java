...
public class end  extends TranslatorBlock {
	private static ResourceBundle uiMessageBundle = ResourceBundle.getBundle("com/ardublock/block/ardublock");
	public end (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{

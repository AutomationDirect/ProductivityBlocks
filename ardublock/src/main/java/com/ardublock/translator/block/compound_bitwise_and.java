...
public class compound_bitwise_and extends TranslatorBlock
{
	private static ResourceBundle uiMessageBundle = ResourceBundle.getBundle("com/ardublock/block/ardublock");
	
	public compound_bitwise_and(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{

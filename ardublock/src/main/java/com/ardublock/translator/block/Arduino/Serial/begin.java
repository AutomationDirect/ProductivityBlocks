...
public class begin extends TranslatorBlock {

	private static ResourceBundle uiMessageBundle = ResourceBundle.getBundle("com/ardublock/block/ardublock");
	public begin (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
	...
	@Override
		public String toCode() throws SocketNullException, SubroutineNotDeclaredException
		{
			...
			String config = this.getRequiredTranslatorBlockAtSocket(1).toCode();
			...
			if(portNumber.equals("0"))
				portNumber = "";
			return "Serial"+portNumber+".begin(" + baud + ", " + config + ");";	
		}
}

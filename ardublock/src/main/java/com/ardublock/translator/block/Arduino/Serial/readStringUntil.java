...
public class readStringUntil extends TranslatorBlock {
	private static ResourceBundle uiMessageBundle = ResourceBundle.getBundle("com/ardublock/block/ardublock");
	public readStringUntil (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
	...
	@Override
		...
		{	
			String terminator = this.getRequiredTranslatorBlockAtSocket(0).toCode();
			...
			if(portNumber.equals("0"))
				portNumber = "";
			return codePrefix + "Serial" + portNumber + ".readStringUntil("+terminator+")" + codeSuffix;	
		}
}

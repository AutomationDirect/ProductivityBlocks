...
public class read extends TranslatorBlock {
	private static ResourceBundle uiMessageBundle = ResourceBundle.getBundle("com/ardublock/block/ardublock");
	public read (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
	...
	@Override
		...
		{	
			...
			if(portNumber.equals("0"))
				portNumber = "";
			return codePrefix + "Serial" + portNumber + ".read()" + codeSuffix;	
		}
}

...
public class availableForWrite  extends TranslatorBlock {

	private static ResourceBundle uiMessageBundle = ResourceBundle.getBundle("com/ardublock/block/ardublock");
	
	public availableForWrite (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
	...
	public String toCode() throws SocketNullException, SubroutineNotDeclaredException
	{
		...
		if(portNumber.equals("0"))
			portNumber = "";
		return codePrefix + "Serial" + portNumber + ".availableForWrite()" + codeSuffix;
	}
}

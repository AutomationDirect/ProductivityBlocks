...
public class GenerateCodeButtonListener implements ActionListener
{
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		RenderableBlock definition_block = null;
		...
		for (RenderableBlock renderableBlock:renderableBlocks)
		{
			...
			if (!block.hasPlug() && (Block.NULL.equals(block.getBeforeBlockID())))
			{
				...
				if(block.getGenusName().equals("P1_program"))
				{
					loopBlockSet.add(renderableBlock);
				}
				...
				if(block.getGenusName().equals("serialEvent")) 
				{
					String functionName = "serialEvent";
					try
					{
						translator.addFunctionName(block.getBlockID(), functionName);
					}
				...
				if(block.getGenusName().equals("definition_block")) {
					definition_block = renderableBlock;
				}
			}
		}
		...
		try
		{
			...
			if(definition_block != null) {
				code.append(translator.translate(definition_block.getBlockID()));
			}

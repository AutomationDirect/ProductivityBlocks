...
public class Page implements WorkspaceWidget, SearchableContainer, ISupportMemento {
    ...
    public static int DEFAULT_ABSTRACT_WIDTH = 700;
    /** The default abstract height */
    public static int DEFAULT_ABSTRACT_HEIGHT = 5000;
    /** An empty string */
...
class PageJComponent extends JLayeredPane implements RBParent {
    ...
    public void paintComponent(Graphics g) {
        ...
        if (fullview) {
            ...
            g.drawString(this.getName(), xpos, getHeight() * 3 / 4);*/ //CHANGED: Don't draw main page label
